...
import { Users, Workflow, ChevronRight, PanelLeftClose, PanelLeft, LogOut } from 'lucide-react';

type WorkspaceUser = { name:string; email:string; role?:string };
export function WorkspaceShell({user,active,onNavigate,onSignOut,busy,children}:{user:WorkspaceUser;active:'toolhub'|'members';onNavigate:(page:'toolhub'|'members')=>void;onSignOut:()=>void;busy:boolean;children:ReactNode}) {
